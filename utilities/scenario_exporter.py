...
def build_scenario_default() -> SimulationState:
    ...
    neran_confed = Civilization(
        ...
        culture_tags={
            ...
            "values:pragmatism": 0.65, "values:ambition": 0.55, "values:prosperity": 0.45,
        },
        theistic=True,
    ...
    keth_civ = Civilization(
        ...
        culture_tags={
            "practice:nomadism": 0.90, "religion:ancestor_worship": 0.85,
            "religion:animism": 0.80, "practice:foraging": 0.70,
            "relations:conquest": 0.60, "structure:egalitarianism": 0.50,
            "values:tenacity": 0.70, "values:folk_wisdom": 0.55, "values:ambition": 0.45,
        },
        theistic=False,
    ...
    damtal_civ = Civilization(
        ...
        culture_tags={
            ...
            "values:ambition": 0.60, "values:tenacity": 0.50, "values:prosperity": 0.45,
        },
        theistic=False,
        divine_awareness=0.10,
        age=260.0,
    ...
    surathi_clans = Civilization(
        ...
        culture_tags={
            ...
            "values:folk_wisdom": 0.70, "values:charity": 0.55, "values:adaptability": 0.50,
        },
        theistic=False,
    ...
    veldan_assembly = Civilization(
        ...
        culture_tags={
            "practice:sedentism": 0.90, "religion:ancestor_worship": 0.85,
            "techno:science": 0.70, "structure:hierarchy": 0.60,
            "relations:diplomacy": 0.50,
            "values:erudition": 0.75, "values:patience": 0.55, "values:sincerity": 0.40,
        },
        theistic=True,
    ...
    vehn_quietude = Civilization(
        ...
        culture_tags={
            "practice:sedentism": 0.90, "religion:ancestor_worship": 0.80,
            "structure:hierarchy": 0.70, "techno:science": 0.75,
            "relations:diplomacy": 0.20,
            "values:patience": 0.70, "values:humility": 0.55, "values:moderation": 0.50,
        },
        theistic=True,
    ...
    pop_neran_elite = Pop(
        ...
        culture_tags={"structure:hierarchy": 0.90, "relations:diplomacy": 0.80,
                      "techno:science": 0.75, "techno:industrialism": 0.70,
                      "values:ambition": 0.70, "values:pragmatism": 0.55, "values:erudition": 0.45},
        visibility=1.0, pinned=True,
    )
    pop_neran_common = Pop(
        ...
        culture_tags={"practice:sedentism": 0.90, "structure:hierarchy": 0.80,
                      ...
                      "religion:luminary_worship": 0.60, "religion:ancestor_worship": 0.50,
                      "values:pragmatism": 0.65, "values:prosperity": 0.55, "values:folk_wisdom": 0.40},
        visibility=1.0, pinned=True,
    )
    pop_neran_artisan = Pop(
        ...
        culture_tags={"techno:science": 0.85, "techno:industrialism": 0.90,
                      ...
                      "values:erudition": 0.65, "values:ambition": 0.55, "values:pragmatism": 0.50},
        visibility=0.0, pinned=False,
    )
    ...
    pop_keth_warrior = Pop(
        ...
        culture_tags={"practice:nomadism": 0.90, "relations:conquest": 0.80,
                      "religion:ancestor_worship": 0.75, "religion:animism": 0.70,
                      "practice:foraging": 0.55, "structure:egalitarianism": 0.50,
                      "values:tenacity": 0.75, "values:ambition": 0.55, "values:folk_wisdom": 0.40},
        visibility=1.0, pinned=True,
    )
    pop_keth_common = Pop(
        civilization_id=keth_civ.id, species_id=keth_species.id,
        ...
        culture_tags={"practice:nomadism": 0.90, "religion:ancestor_worship": 0.85,
                      "religion:animism": 0.80, "practice:foraging": 0.70,
                      "relations:conquest": 0.50, "structure:egalitarianism": 0.55,
                      "values:folk_wisdom": 0.65, "values:tenacity": 0.55, "values:patience": 0.40},
        visibility=0.0, pinned=False,
    )
    ...
    pop_damtal_elite = Pop(
        ...
        culture_tags={"structure:hierarchy": 0.90, "relations:conquest": 0.70,
                      ...
                      "values:ambition": 0.75, "values:prosperity": 0.55, "values:tenacity": 0.50},
        visibility=0.0, pinned=False,
    )
    pop_damtal_common = Pop(
        ...
        culture_tags={"practice:agriculture": 0.80, "practice:sedentism": 0.75,
                      ...
                      "values:folk_wisdom": 0.65, "values:prosperity": 0.50, "values:patience": 0.45},
        visibility=0.0, pinned=False,
    )
    ...
    pop_surathi_priest = Pop(
        ...
        culture_tags={"religion:animism": 0.90, "religion:ancestor_worship": 0.70,
                      ...
                      "values:folk_wisdom": 0.75, "values:charity": 0.55, "values:humility": 0.40},
        visibility=0.0, pinned=False,
    )
    ...
    pop_surathi_confederate = Pop(
        ...
        culture_tags={"relations:commerce": 0.75, "relations:diplomacy": 0.65,
                      ...
                      "values:adaptability": 0.60, "values:pragmatism": 0.55, "values:ambition": 0.45},
    ...
    pop_veldan_council = Pop(
        ...
        culture_tags={"religion:ancestor_worship": 0.90, "techno:science": 0.75,
                      "structure:hierarchy": 0.70, "practice:sedentism": 0.90,
    ...
    pop_veldan_common = Pop(
        ...
        culture_tags={"practice:sedentism": 0.90, "techno:science": 0.65,
                      "relations:diplomacy": 0.50, "religion:ancestor_worship": 0.70,
                      "structure:hierarchy": 0.50,
                      "values:erudition": 0.65, "values:pragmatism": 0.55, "values:patience": 0.45},
        visibility=0.0, pinned=False,
    )
    ...
    pop_vehn_council = Pop(
        ...
        culture_tags={"structure:hierarchy": 0.80, "practice:sedentism": 0.90,
                      "techno:science": 0.70, "religion:ancestor_worship": 0.75,
                      "values:humility": 0.70, "values:patience": 0.55, "values:moderation": 0.45},
        visibility=0.0, pinned=False,
    )
    pop_vehn_common = Pop(
        civilization_id=vehn_quietude.id, species_id=vehn_species.id,
        ...
        culture_tags={"practice:sedentism": 0.90, "techno:science": 0.75,
                      "structure:hierarchy": 0.65, "religion:ancestor_worship": 0.80,
                      "values:patience": 0.70, "values:moderation": 0.55, "values:folk_wisdom": 0.40},
        visibility=0.0, pinned=False,
    )
    ...
    senna = NotableMortal(
        ...
        personal_tags=["status:senator", "personal:ambitious", "personal:pragmatic"],
    ...
    karath = NotableMortal(
        ...
        personal_tags=["status:commander", "personal:ambitious", "personal:ruthless"],
    ...
    veth = NotableMortal(
        ...
        personal_tags=["status:high_priest", "personal:devout", "personal:cautious"],
        culture_tags={"religion:luminary_worship": 0.55, "religion:demiurge_worship": 0.85, "practice:sedentism": 0.80,
    ...
    durenn = NotableMortal(
        ...
        personal_tags=["status:trade_magnate", "personal:opportunistic", "personal:pragmatic"],
    ...
    asha = NotableMortal(
        ...
        personal_tags=["status:tribal_leader", "personal:spiritual"],
    ...
    orryn = NotableMortal(
        ...
        personal_tags=["status:dissident", "personal:agitator", "personal:charismatic"],
    ...
    thessal = NotableMortal(
        ...
        personal_tags=["personal:obsessive", "personal:reclusive"],
    ...
    maeva = NotableMortal(
        ...
        personal_tags=["personal:devout", "personal:receptive"],
    ...
    kael = NotableMortal(
        ...
        personal_tags=["status:clan_elder", "personal:ambitious", "personal:suspicious"],
    ...
    urren = NotableMortal(
        ...
        personal_tags=["status:shaman", "personal:spiritual", "personal:perceptive"],
    ...
    ren_caleth = NotableMortal(
        ...
        personal_tags=["status:colony_governor", "personal:pragmatic", "personal:cautious"],
    ...
    yssa_tharn = NotableMortal(
        ...
        personal_tags=["status:colonial_surveyor", "personal:methodical"],
    ...
    orrath = NotableMortal(
        ...
        prominence_roles=[MortalProminence.LEADER], prominence=0.50, visibility=0.0,
        personal_tags=["status:clan_elder", "personal:patient", "personal:perceptive"],
    ...
    deva = NotableMortal(
        ...
        personal_tags=["status:spirit_caller", "personal:spiritual", "personal:receptive"],
    ...
    yakkel = NotableMortal(
        ...
        personal_tags=["status:hunt_chief", "personal:fierce", "personal:loyal"],
    ...
    sirak = NotableMortal(
        ...
        personal_tags=["status:liaison", "personal:opportunistic", "personal:charismatic"],
    ...
    var_keth = NotableMortal(
        ...
        personal_tags=["status:paramount_king", "personal:ambitious", "personal:ruthless"],
    ...
    issel = NotableMortal(
        ...
        personal_tags=["status:high_priestess", "personal:devout", "personal:patient"],
    ...
    durrak = NotableMortal(
        ...
        personal_tags=["status:warlord", "personal:aggressive", "personal:pragmatic"],
    ...
    yellan = NotableMortal(
        ...
        role=MortalRole.OTHER, status=MortalStatus.ACTIVE, species_id=damtal_species.id,
        prominence_roles=[MortalProminence.SCHOLAR], prominence=0.30, visibility=0.0,
        personal_tags=["status:lore_keeper", "personal:obsessive", "personal:perceptive"],
    ...
    councilor_yeth = NotableMortal(
        ...
        personal_tags=["status:first_councilor", "personal:deliberate", "personal:wise"],
    ...
    keeper_orvan = NotableMortal(
        ...
        personal_tags=["status:archive_keeper", "personal:reclusive", "personal:perceptive"],
    ...
    sivel = NotableMortal(
        ...
        personal_tags=["status:first_arbiter", "personal:deliberate", "personal:wise"],
    ...
    orveth = NotableMortal(
        ...
        personal_tags=["status:deep_keeper", "personal:reclusive", "personal:obsessive"],
        culture_tags={"religion:ancestor_worship": 0.90, "practice:sedentism": 0.90, "techno:science": 0.70,
    ...
    valn = NotableMortal(
        ...
        personal_tags=["status:fleet_commander", "personal:pragmatic", "personal:disciplined"],
    ...
    kern = NotableMortal(
        ...
        personal_tags=["status:colonial_warden", "personal:methodical", "personal:patient"],
        culture_tags={"practice:sedentism": 0.90, "structure:hierarchy": 0.75, "religion:ancestor_worship": 0.70,
                      "values:patience": 0.75, "values:humility": 0.55, "values:pragmatism": 0.45},
        belief_tags={"domain:silence": 0.55, "domain:secrecy": 0.50, "domain:mastery": 0.40, "domain:order": 0.35},
        alignment=0.0, chrono_age=207.0, bio_age=207.0,
