...
def build_scenario_default() -> SimulationState:
    ...
    veth = NotableMortal(
        ...
        culture_tags={"religion:luminary_worship": 0.90, "religion:demiurge_worship": 0.85, "practice:sedentism": 0.80},
    ...
    thessal = NotableMortal(
        ...
        belief_tags={"domain:order": 0.55, "domain:silence": 0.50, "domain:mastery": 0.50, "domain:truth": 0.40, "domain:secrecy": 0.30},
    ...
    kael = NotableMortal(
        ...
        belief_tags={"domain:conflict": 0.70, "domain:change": 0.40, "domain:mastery": 0.30, "domain:memory": 0.20},
    ...
    korax = NotableMortal(
        ...
        culture_tags={},
        belief_tags={"domain:void": 0.55, "domain:memory": 0.30, "domain:conflict": 0.20},
