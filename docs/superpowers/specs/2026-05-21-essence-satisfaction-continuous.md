...
**Date:** 2026-05-21
**Scope:** Replace binary above/below threshold check with ratio-based continuous scoring
**Status:** Draft
**Affects:** `core/eval_core.py` — `evaluate_essence_satisfaction` and `EssenceSatisfaction`
...
| `logic/tick_logic.py` | Update Ask for Orders report to display `surplus_ratio` and trajectory |
