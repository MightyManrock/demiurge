...
| [action-success-rework.md](action-success-rework.md) | `active` | Rework action success/failure math; fold Framing into success likelihood |
| [manifest-omen-recost.md](manifest-omen-recost.md) | `blocked` | Re-cost Manifest Omen — blocked on action success rework |
