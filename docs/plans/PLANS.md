...
| [soft-queue-action-system.md](soft-queue-action-system.md) | `active` | Unify action_queue + ongoing_actions into pending_actions; repeating flag; per-category pending modal |
