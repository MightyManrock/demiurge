...
| [rtwp-action-system.md](rtwp-action-system.md) | `active` | RTwP refactor: continuous auto-advance, per-category cooldowns, auto-pause, category panel UI, tick scale to days |
