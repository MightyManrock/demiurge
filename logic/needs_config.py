...
NEED_DEFAULTS: dict[str, dict[str, float]] = {
    ...
    NEED_BELONGING:  {"decay_rate": 0.04,  "pressing_threshold": 0.65, "urgent_threshold": 0.30},
    ...
    NEED_LEISURE:    {"decay_rate": 0.04,  "pressing_threshold": 0.65, "urgent_threshold": 0.30},
}
