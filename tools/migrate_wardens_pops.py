...
NERAN_SURFACE_POPS = [
    (SocialClass.ELITE, "poli_admin", 5.0, "Senna Vaur",
    ...
    (SocialClass.ELITE, "noble", 3.5, None,
    ...
    (SocialClass.SCHOLAR, "scientist", 6.5, None,
    ...
    (SocialClass.SCHOLAR, "academic", 6.2, None,
    ...
    (SocialClass.SCHOLAR, "clergy", 4.5, "Veth Sarai",
    ...
    (SocialClass.TRADER, "merchant", 6.7, "Durenn Vail",
    ...
    (SocialClass.TRADER, "executive", 6.5, None,
    ...
    (SocialClass.TRADER, "financier", 6.0, None,
    ...
    (SocialClass.ARTISAN, "engineer", 7.5, "Thessal Dour",
    ...
    (SocialClass.ARTISAN, "technician", 7.8, "Orryn Vel",
    ...
    (SocialClass.ARTISAN, "crafter", 7.0, None,
    ...
    (SocialClass.ARTISAN, "builder", 6.0, None,
    ...
    (SocialClass.ARTISAN, "healer", 5.5, None,
    ...
    (SocialClass.ARTISAN, "artist", 5.5, None,
    ...
    (SocialClass.COMMON, "professional", 8.2, None,
    ...
    (SocialClass.COMMON, "producer", 7.8, None,
    ...
    (SocialClass.COMMON, "transport", 7.0, None,
    ...
    (SocialClass.COMMON, "service", 9.0, "Maeva Sorn",
    ...
    (SocialClass.COMMON, "laborer", 8.5, None,
    ...
    (SocialClass.WARRIOR, "officer", 4.0, None,
    ...
    (SocialClass.WARRIOR, "guard", 5.5, None,
    ...
    (SocialClass.WARRIOR, "soldier", 5.5, None,
    ...
    (SocialClass.UNDERCLASS, "dispossessed", 5.5, None,
...
NERAN_ORBITAL_RING_POPS = [
    (SocialClass.WARRIOR, "officer", 4.0, "Karath Omn",
    ...
    (SocialClass.WARRIOR, "soldier", 3.5, None,
    ...
    (SocialClass.WARRIOR, "guard", 4.0, None,
    ...
    (SocialClass.SCHOLAR, "scientist", 4.2, None,
    ...
    (SocialClass.ARTISAN, "engineer", 4.5, None,
    ...
    (SocialClass.ARTISAN, "technician", 5.2, None,
    ...
    (SocialClass.ARTISAN, "healer", 3.5, None,
    ...
    (SocialClass.COMMON, "transport", 5.5, None,
    ...
    (SocialClass.COMMON, "service", 4.8, None,
    ...
    (SocialClass.COMMON, "laborer", 3.8, None,
