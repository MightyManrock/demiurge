...
class Location(BaseModel):
    ...
    name: str
    description: str = ""
    location_type: str          # "galaxy", "plane", "wheel", "city" — free or enum
...
class SignificantLocation(Location):               # Planets, planes, and other "mid-level" locations that "collect" domain expression and footprint data
...
class Species(BaseModel):
    ...
    domain_tags: list[str] = Field(default_factory=list)    # Only for innate divine domain affinity
